...
public final class MockRockyService implements RockyService{
    ...
    @Inject MockRockyService(MockRetrofit mockRetrofit, SharedPreferences preferences) {
        this.delegate = mockRetrofit.create(RockyService.class);
        this.preferences = preferences;

        //TODO creat mock responses
//        loadResponse(MockRepositoriesResponse.class, MockRepositoriesResponse.SUCCESS);

    }

    @Override
    public Observable<Result> register(@Query("name") String name) {
        return null;
    }
